  ...
  return (
    <Dialog onOpenChange={(value) => {
      ...
      <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto'>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onsubmit)} noValidate className='grid auto-rows-max items-start gap-4 md:gap-8' id='add-dish-form'>
